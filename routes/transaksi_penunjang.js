...
router.get('/',function(req,res,next){
	TransaksiPenunjang.findAll({raw:true}).then( async data=>{
...
router.post('/',function(req,res,next){
    ...
    TransaksiPenunjang.create(req.body).then( data=>{
        res.json({
            status:true,
...
router.put('/',function(req,res,next){
	TransaksiPenunjang.update(req.body,{
